...
TARGET_API_KEY_ENV=${TARGET_API_KEY_ENV:-OPENAI_API_KEY}
TARGET_BASE_URL=${TARGET_BASE_URL:-}
TARGET_REASONING_EFFORT=${TARGET_REASONING_EFFORT:-none}
...
WORLDSIM_PROVIDER=${WORLDSIM_PROVIDER:-openai}
WORLDSIM_MODEL=${WORLDSIM_MODEL:-gpt-5.6-luna}
WORLDSIM_API_KEY_ENV=${WORLDSIM_API_KEY_ENV:-OPENAI_API_KEY}
WORLDSIM_BASE_URL=${WORLDSIM_BASE_URL:-}
WORLDSIM_REASONING_EFFORT=${WORLDSIM_REASONING_EFFORT:-none}
